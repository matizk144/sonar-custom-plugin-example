 ...
 */
package org.sonarsource.plugins.bitbucket.hooks;
...
public class FillPullRequestJob implements PostJob {

  private static final Logger LOGGER = Loggers.get(FillPullRequestJob.class);
